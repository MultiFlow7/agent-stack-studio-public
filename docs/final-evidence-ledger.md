...
台账覆盖 8 条跨领域用户旅程：当前项目/项目设置、Agent、组件库/Stack/Workflow、Runtime/Run、Experiment、来源发现、备份/恢复/Keychain 与命令中心。每条都必须显式分类：
...
- `npm run verify:evidence-ledger`：检查 M32 当前 110 条 LC、43 条 RR、8 条旅程、8 个状态维度、23 个截图生成器、9 条验证命令和 4 个包产物路径。
