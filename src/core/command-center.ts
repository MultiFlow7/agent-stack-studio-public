...
const navigationResults: CommandCenterResult[] = [
  ['agents', 'Agent', '选择 Harness、添加能力并冻结版本'],
  ['components', '组件', '管理 Harness、能力和公开来源'],
  ['runs', '运行', '聊天、单次运行和本机历史'],
  ['publish', '发布', '校验冻结版本并发布到 Multica'],
    ...
    ? [
        {
          ...
          detail: `当前项目 · revision ${source.project.project.revision}`,
